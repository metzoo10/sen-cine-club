	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<p class="fw-bold">Bande annonce : <a href="<?php echo $film['lien_ba']; ?>" target="_blank" class="fw-bold text-decoration-none"><img src="images/logos/youtube.png" alt="Logo Youtube" height="30" class="logo"></a></p>
			</div>
		</div>
	</div>
